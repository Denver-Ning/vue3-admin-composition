...
var require_lib = __commonJS({
  "node_modules/@babel/parser/lib/index.js"(exports) {
      ...
      readToken_lt_gt(code) {
        ...
        if (next === code) {
          ...
          if (this.input.charCodeAt(this.state.pos + size2) === 61) {
            this.finishOp(36, size2 + 1);
            return;
          }
          this.finishOp(51, size2);
          return;
        }
        if (next === 61) {
          size2 = 2;
        }
        this.finishOp(50, size2);
      }
    ...
    var typescript = (superClass) => class extends superClass {
      ...
      tsParseDelimitedList(kind, parseElement2) {
        return nonNull(this.tsParseDelimitedListWorker(kind, parseElement2, true));
      }
      tsParseDelimitedListWorker(kind, parseElement2, expectSuccess) {
        const result = [];
        for (; ; ) {
      ...
      tsParseBracketedList(kind, parseElement2, bracket, skipFirstToken) {
        if (!skipFirstToken) {
          if (bracket) {
            this.expect(8);
          } else {
        ...
        const result = this.tsParseDelimitedList(kind, parseElement2);
        if (bracket) {
          this.expect(11);
        } else {
          this.expectRelational(">");
    ...
    var ExpressionParser = class extends LValParser {
      ...
      parseSubscript(base, startPos, startLoc, noCalls, state) {
        ...
        if (!noCalls && this.match(18)) {
          ...
          const computed2 = this.eat(8);
          if (computed2 || optional || this.eat(24)) {
            return this.parseMember(base, startPos, startLoc, state, computed2, optional);
          } else {
            state.stop = true;
            return base;
          }
      ...
      parseMember(base, startPos, startLoc, state, computed2, optional) {
        const node = this.startNodeAt(startPos, startLoc);
        node.object = base;
        node.computed = computed2;
        const privateName = !computed2 && this.match(6) && this.state.value;
...
//# sourceMappingURL=chunk-YY3DFBV2.js.map
