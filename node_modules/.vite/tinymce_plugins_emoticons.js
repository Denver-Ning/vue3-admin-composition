  ...
  "node_modules/tinymce/plugins/emoticons/plugin.js"() {
    (function() {
      ...
      var getUserDefinedEmoticons = function(editor) {
        ...
        return map(userDefinedEmoticons, function(value2) {
          return __assign({
            keywords: [],
            category: "user"
          }, value2);
      ...
      var initDatabase = function(editor, databaseUrl, databaseId) {
        ...
        var processEmojis = function(emojis) {
          ...
          each(emojis, function(lib, title) {
            ...
            var current = cats[entry.category] !== void 0 ? cats[entry.category] : [];
      ...
      var open = function(editor, database) {
        ...
        var scan = function(dialogApi2) {
          var dialogData = dialogApi2.getData();
        ...
        var getInitialState = function() {
          ...
          return {
            ...
            onAction: function(dialogApi2, actionData) {
      ...
      var init = function(editor, database) {
        editor.ui.registry.addAutocompleter("emoticons", {
          ...
          onAction: function(autocompleteApi, rng, value2) {
