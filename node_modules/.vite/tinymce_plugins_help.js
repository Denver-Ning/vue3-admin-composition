    ...
    (function() {
      ...
      var tab$1 = function(editor) {
        ...
        var getPluginKeys = function(editor2) {
          ...
          return forced_plugins === void 0 ? keys$1 : filter(keys$1, function(k) {
      ...
      var parseCustomTabs = function(editor, customTabs) {
        ...
        var versions = tab();
        var tabs = __assign((_a = {}, _a[shortcuts2.name] = shortcuts2, _a[nav.name] = nav, _a[plugins.name] = plugins, _a[versions.name] = versions, _a), customTabs.get());
